...
@vimrc@ is briefly based on configuration from "lusis vim
configs":https://github.com/lusis/vim-configs and mainly on "kremso vimrc":https://github.com/kremso/dotfiles 
