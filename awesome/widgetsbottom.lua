...
plaympdwidget = widget({ type = "imagebox" })	
plaympdwidget.image = image(theme.widget_mpd_play)
stopmpdwidget = widget({ type = "imagebox" })
stopmpdwidget.image = image(theme.widget_mpd_stop)
pausempdwidget = widget({ type = "imagebox" })
pausempdwidget.image = image(theme.widget_mpd_pause)
nextmpdwidget = widget({ type = "imagebox" })
nextmpdwidget.image = image(theme.widget_mpd_next)
prevmpdwidget = widget({ type = "imagebox" })
prevmpdwidget.image = image(theme.widget_mpd_prev)
--
